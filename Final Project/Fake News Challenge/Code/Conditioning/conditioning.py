...
class Config:
	...
	max_length_articles = 700 #changed from 700
	num_classes = 4
	epochs = 10
	lr = 0.001
	dropout = 1.0
...
if __name__ == "__main__":
	...
	articleContext = tf.concat(1, [article_states[0][1], article_states[1][1]])
	articleContext_expanded = tf.tile(tf.expand_dims(articleContext, axis = 1), [1, Config.max_length_titles, 1])
	conditionalInput = tf.concat(2, [headlineConcatenatedHidden, articleContext_expanded])
