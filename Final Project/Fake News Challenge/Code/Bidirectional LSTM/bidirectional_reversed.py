...
#		headline_output, headline_state_fw, headline_state_bw = tf.nn.bidirectional_rnn(headline_cell_fw, headline_cell_bw, 
#			tf.unpack(tf.transpose(headline_embedded_tensor, perm = [1, 0, 2])), 
