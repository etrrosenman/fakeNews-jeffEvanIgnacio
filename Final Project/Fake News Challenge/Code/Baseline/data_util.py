...
#        tok2id = build_dict((normalize(word) for sentence, _ in data for word in sentence), offset=1, max_words=10000)
        ...
        tok2id = build_dict((normalize(word) for article, headline, _ in data for word in article + headline), offset=1, max_words=50000)
